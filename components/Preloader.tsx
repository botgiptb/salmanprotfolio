...
/* Total animation duration — must match CSS --pl-duration below */
const DISMISS_AFTER = 3600; // ms — slightly longer than CSS animation
        ...
        >
          ...
          <div className="relative flex flex-col items-center gap-8 w-full max-w-[480px] px-8">
            ...
            <div className="w-full flex flex-col gap-3">
              ...
              {/* CSS-driven bar — never gets stuck */}
